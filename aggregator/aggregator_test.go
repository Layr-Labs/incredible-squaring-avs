...
import (
	...
	"github.com/ehsueh/trade-algo-avs-avs/aggregator/mocks"
	"github.com/ehsueh/trade-algo-avs-avs/aggregator/types"
...
func createMockAggregator(
	...
	aggregator := &Aggregator{
		...
		tasks:                 make(map[types.TaskIndex]cstaskmanager.ITradeAlgoTaskManagerTask),
		taskResponses:         make(map[types.TaskIndex]map[sdktypes.TaskResponseDigest]cstaskmanager.ITradeAlgoTaskManagerTaskResponse),
	}
