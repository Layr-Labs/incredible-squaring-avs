...
func (o *Operator) ProcessNewTaskCreatedLog(newTaskCreatedLog *cstaskmanager.ContractCredibleSquaringTaskManagerNewTaskCreated) *cstaskmanager.ICredibleSquaringTaskManagerTaskResponse {
...
func (o *Operator) SignTaskResponse(taskResponse *cstaskmanager.ICredibleSquaringTaskManagerTaskResponse) (*aggregator.SignedTaskResponse, error) {
