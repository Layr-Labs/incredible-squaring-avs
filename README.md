...
- Operator: The operator suscribes to NewTasks Events, and in case a new task ins created, completes the task, calculates the response, signs it and sends it to the bls aggregation service.
