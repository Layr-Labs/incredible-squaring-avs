#!/bin/sh
# Script adapted from https://github.com/Layr-Labs/eigenlayer-cli
...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for Layr-Labs/avs-devnet
...
Usage: $this [-b bindir] [-d] [tag] [-c]
  ...
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/Layr-Labs/avs-devnet/releases
...
get_binaries() {
  case "$PLATFORM" in
    darwin/amd64) BINARIES="avs-devnet" ;;
    darwin/arm64) BINARIES="avs-devnet" ;;
    linux/amd64) BINARIES="avs-devnet" ;;
    linux/arm64) BINARIES="avs-devnet" ;;
    *)
