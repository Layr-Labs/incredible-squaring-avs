...
// this hardcodes abi.encode() for cstaskmanager.ICredibleSquaringTaskManagerTaskResponse
// unclear why abigen doesn't provide this out of the box...
func AbiEncodeTaskResponse(h *cstaskmanager.ICredibleSquaringTaskManagerTaskResponse) ([]byte, error) {

	// The order here has to match the field ordering of cstaskmanager.ICredibleSquaringTaskManagerTaskResponse
...
func GetTaskResponseDigest(h *cstaskmanager.ICredibleSquaringTaskManagerTaskResponse) ([32]byte, error) {
